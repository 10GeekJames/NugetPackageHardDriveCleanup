...
namespace NodePackagesCleanup
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (dirNameLower == "net5.0" || dirNameLower == "debug")
            {
                executeIn = System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location) + "\\..\\..\\..\\";
            }

            DirectoryInfo directories = new DirectoryInfo(System.IO.Path.Combine(executeIn, "..\\"));
            ...
            directories = new DirectoryInfo(System.IO.Path.Combine(executeIn, "..\\"));
